...
<html>
    <head>
        ...
        <link href="<?php echo (ADMIN_VIEW_PATH); ?>css/admin.css" type="text/css" rel="stylesheet" />
    ...
    <body>
        <table height="100%" cellspacing=0 cellpadding=0 width=170 
               background=<?php echo (ADMIN_VIEW_PATH); ?>img/menu_bg.jpg border=0>
               <tr>
                <td valign=top align=middle>
                    ...
                    <table cellspacing=0 cellpadding=0 width=150 border=0>
                        ...
                        <tr height=22>
                            <td style="padding-left: 30px" background=<?php echo (ADMIN_VIEW_PATH); ?>img/menu_bt.jpg ><a
                    ...
                    <table id=child1 style="display: none" cellspacing=0 cellpadding=0 
                        ...
                        <tr height=20>
                            <td align=middle width=30><img height=9 
                                                           src="<?php echo (ADMIN_VIEW_PATH); ?>img/menu_icon.gif" width=9></td>
                            <td><a class=menuchild
                                   href="/index.php/Admin/Chapter/Chapterlist"
                                   target=right>文章列表</a></td></tr>
                        <tr height=20>
                            <td align=middle width=30><img height=9
                                                           src="<?php echo (ADMIN_VIEW_PATH); ?>img/menu_icon.gif" width=9></td>
                            <td><a class=menuchild
                                   href="/index.php/Admin/Chapter/Chapteradd"
                                   target=right>新建文章</a></td></tr>
                        <tr height=20>
                            <td align=middle width=30><img height=9
                                                           src="<?php echo (ADMIN_VIEW_PATH); ?>img/menu_icon.gif" width=9></td>
                            <td><a class=menuchild
                                   href="/index.php/Admin/Chapter/ChapterCategory"
